...
def parse_arguments():
    ...
    # Data directories
    parser.add_argument('--data_dir', type=str, default='/home/akv020/fennomag/fennomag-net/data', 
                        help='Base directory for magnetometer data')
    parser.add_argument('--secs_dir', type=str, default='/home/akv020/fennomag/fennomag-net/data/secs', 
